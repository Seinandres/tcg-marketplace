      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-gradient-to-br from-[#0f172a] to-[#1e1b4b] border border-purple-500/20 rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-black uppercase text-white mb-2 tracking-tight">Bienvenido Guerrero</h1>
            <p className="text-sm text-slate-400 font-bold uppercase tracking-widest">Ingresa a la Arena</p>
          </div>
          ...
          <div className="text-center">
            <p className="text-sm text-slate-400 mb-3">¿Nuevo en la arena?</p>
            <Link href="/auth/register" className="inline-block w-full bg-slate-800/50 hover:bg-slate-700/50 border border-white/10 hover:border-purple-500/50 text-white font-bold uppercase text-sm tracking-wider py-3 rounded-xl transition-all hover:scale-[1.02] active:scale-95">
